    ...
    public void onTestFailure(ITestResult result)
      {
        ...
        //WebDriver driver = ((TestBase)result.getInstance()).driver;
          String path = captureScreen(((BaseTest)result.getInstance()).getDriverManager().getDriver(), result.getMethod().getMethodName());
    ...
    public String captureScreen(WebDriver driver, String screenShotName)
      {
        ...
        String fileName="AutomationReport_"+screenShotName+dFormat.format(calendar.getTimeInMillis())+".png";
